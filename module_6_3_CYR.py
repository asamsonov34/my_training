...
class Утконос(PoisonousAnimal, AquaticAnimal, Bird): # Просто попробовать кириллицу в названии класса. Хм, работает.
...
db.speak() # Пробовал кириллицу ради этой функции, см. её объявление
db.attack()
